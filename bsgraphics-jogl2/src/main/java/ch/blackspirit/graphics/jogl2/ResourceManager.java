...
final class ResourceManager implements
	...
	private HashSet<ch.blackspirit.graphics.jogl2.Image> cachedImages = 
		new HashSet<ch.blackspirit.graphics.jogl2.Image>();
	...
	void updateBuffer(ch.blackspirit.graphics.jogl2.Image image) {
		updateBuffer(image, 0, 0, image.getWidth(), image.getHeight());
	}

	void updateBuffer(ch.blackspirit.graphics.jogl2.Image image, int xOffset, int yOffset, int width, int height) {
